  ...
  const handleToggleSubtask = (taskId, subtaskId, e) => {
    ...
    setTasks(tasks.map(t => {
      if (t.id === taskId) {
        ...
        // If all subtasks are completed, do we complete the task? Let's leave task independent or autodetect
        ...
        {activeTab === 'tasks' && (
          <>
            ...
            <header className="app-header">
              ...
              {/* Today's completion circular progress card */}
              <div className="progress-card">
                <div className="progress-info">
                  <h3>Today's Completion</h3>
                  <p>{stats.completed} of {stats.total} tasks completed ({stats.percent}%)</p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="task-content">
                        ...
                        {/* Expanded Checklist Subtask Details */}
                        {isExpanded && (
                          <div 
                            className="subtasks-list fade-in" 
                          ...
                          >
                            ...
                            {task.subtasks.map(sub => (
                              ...
                              >
                                ...
                                <span style={{ textDecoration: sub.completed ? 'line-through' : 'none', color: sub.completed ? 'var(--text-muted)' : 'var(--text-primary)' }}>
                                  {sub.title}
                                </span>
                              </label>
                            ))}
